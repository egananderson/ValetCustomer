...
- (void)loadFromDatabaseWithCompletion:(void (^)(BOOL success))completion {
    ...
    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:@"http://192.168.1.10:4488/valet/select_location.php"] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
